...
class SearchAdapter(private val context: Context): RecyclerView.Adapter<SearchAdapter.FeedViewHolder>() {
    private var collect:List<MoviesItem> = emptyList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeedViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.searchitem, parent, false)
